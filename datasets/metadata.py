...
for f_path in glob('/Users/chominjae/Desktop/Capstone/Audio/split/**', recursive=True): # loop directory recursively
...
df.to_csv("metadata.csv", index=False, header=False) # create csv from df